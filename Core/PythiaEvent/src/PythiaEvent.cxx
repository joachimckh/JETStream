...
void PythiaEvent::setJetSubstructure(const int& jetid, const int& cstind, const float& pt, const float& e, const int& flavor, const float& deltaR, const JetType jetType)
{
  ...
  case JetType::antikt:
    ...
    break;
  case JetType::kt:
    ktJet.setJetConstituents(jetid, cstind, pt, e, flavor, deltaR);
    break;
  case JetType::cambridge:
    cambridgeJet.setJetConstituents(jetid, cstind, pt, e, flavor, deltaR);
    break;
  case JetType::siscone:
    sisconeJet.setJetConstituents(jetid, cstind, pt, e, flavor, deltaR);
    break;
  default:
    break;
  }
